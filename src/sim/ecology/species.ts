...
export const BASE_SPECIES: SpeciesDef[] = [
  ...
  { id: 9, name: 'Lion', plural: 'lions', diet: 'carnivore', body: 'lion', size: 1.1, speed: 0.46, biomes: { [B.Savanna]: 1, [B.Grassland]: 0.6, [B.Desert]: 0.2 }, tMin: 8, tMax: 44, herdMin: 2, herdMax: 6, adultAge: 2.5, maxAge: 14, litter: 2, gestation: 460, metabolism: 0.00094, prey: [3, 2, 4, 1], sight: 47, meat: 1.0, migratory: false, nocturnal: true, hibernates: false, colour: 0xc9964e, colour2: 0x7a4a24, parent: -1, softCap: 56 },
  ...
  { id: 11, name: 'Jaguar', plural: 'jaguars', diet: 'carnivore', body: 'cat', size: 0.8, speed: 0.44, biomes: { [B.Rainforest]: 1, [B.Wetland]: 0.5, [B.Savanna]: 0.2 }, tMin: 14, tMax: 40, herdMin: 1, herdMax: 1, adultAge: 2.5, maxAge: 13, litter: 2, gestation: 420, metabolism: 0.00094, prey: [7, 0, 1], sight: 39, meat: 0.8, migratory: false, nocturnal: true, hibernates: false, colour: 0xd49a3a, colour2: 0x2a1e12, parent: -1, softCap: 42 },
